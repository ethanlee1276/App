...
#: THE NOTES ARE ABOUT THE BUILDING, NEVER THE SEASON (Ethan, 2026-09-24,
#: beside Lambeau at 69°F: the note said "late-season cold here is severe
#: enough to affect ball handling and kicking" under a September forecast).
#: A note is printed on every game at the venue, so it cannot say what the
#: weather will be; and several of the old ones claimed effects this repo
#: measured and did not find — cold on its own moved nothing once wind,
#: rain and snow were separated (engine/weather, engine/wxfit). What
#: tonight's weather does is the model's own read, `conditions.why`, which
#: the game page prints under its own heading.
STADIUMS: dict[str, Stadium] = {
    ...
    "DEN": Stadium("DEN", "Empower Field at Mile High", "outdoors", "grass", 5280, 76125, 2001,
                   "A mile above sea level: thin air lets a kicked ball carry farther — the one "
                   "NFL venue where altitude is a real, repeatable effect. Open air."),
    ...
    "JAX": Stadium("JAX", "EverBank Stadium", "outdoors", "grass", 16, 67814, 1995,
                   "Open air in Jacksonville."),
    "KC": Stadium("KC", "GEHA Field at Arrowhead Stadium", "outdoors", "grass", 889, 76416, 1972,
                  "Open air on natural grass, and one of the loudest stadiums in the league."),
    ...
    "MIA": Stadium("MIA", "Hard Rock Stadium", "outdoors", "grass", 8, 65326, 1987,
                   "Open air, with a canopy over the seats but not the field."),
    ...
    "NYG": Stadium("NYG", "MetLife Stadium", "outdoors", "turf", 25, 82500, 2010,
                   "Open air in the Meadowlands, where wind swirls in the bowl."),
    ...
    "PHI": Stadium("PHI", "Lincoln Financial Field", "outdoors", "grass", 39, 69796, 2003,
                   "Open air in South Philadelphia."),
    "PIT": Stadium("PIT", "Acrisure Stadium", "outdoors", "grass", 730, 68400, 2001,
                   "Open air at the confluence of three rivers."),
    "SEA": Stadium("SEA", "Lumen Field", "outdoors", "turf", 20, 68740, 2002,
                   "A partial roof over the seats throws crowd noise back into the bowl; the "
                   "field itself is open to the weather."),
    "SF": Stadium("SF", "Levi's Stadium", "outdoors", "grass", 10, 68500, 2014,
                  "Open air in Santa Clara."),
