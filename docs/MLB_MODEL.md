...
| §10 Fractional Kelly + caps | 🟡 | Quarter default, half only A+ Tier 1 — as a VETO. The price sizes (`engine/staking.py`'s ladder, 2026-08-12), so the 2u/1u/0.5u grade caps named here are retired and the ladder's 0.35u–1.25u ends bound a play; 5u/game + 15u/slate (`apply_exposure_caps`) are live, and the slate cap is MLB's volume-bleed defense |
